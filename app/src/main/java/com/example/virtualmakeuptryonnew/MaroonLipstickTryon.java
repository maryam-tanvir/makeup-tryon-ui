...
public class MaroonLipstickTryon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maroon_lipstick_tryon);
        ...
        buyProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // URL to open
                String url = "https://cozmetica.pk/products/la-girl-lip-attraction-2-lipstick-cheery?pr_prod_strat=e5_desc&pr_rec_id=cff1492e1&pr_rec_pid=7750112018593&pr_ref_pid=7750112116897&pr_seq=uniform";
...
//        OkHttpClient client = new OkHttpClient();
        ...
        Request request = new Request.Builder()
                .url(baseUrl + "/apply-makeup/?choice=lips&red=128&green=0&blue=0")
                .post(requestBody)
                .build();
