...
public class BlackKajalTryon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_black_kajal_tryon);
        ...
        buyProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // URL to open
                String url = "https://www.inglotpk.com/products/kohl-pencil?variant=32652771033191";
...
//        OkHttpClient client = new OkHttpClient();
        ...
        RequestBody requestBody = new MultipartBody.Builder()
                ...
                .addFormDataPart("audio_file", "image.png", RequestBody.create(MediaType.parse("image/*"), imageBytes))
                .build();

        String baseUrl = getResources().getString(R.string.apiUrl);
        // Create POST request
        Request request = new Request.Builder()
                .url(baseUrl + "/apply_kajal?red=255&green=255&blue=255")
                .post(requestBody)
                .build();
