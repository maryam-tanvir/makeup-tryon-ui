...
public class DustyPinkBlushTryon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dusty_pink_blush_tryon);
        ...
        buyProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // URL to open
                String url = "https://www.makeupcityshop.com/products/13827?pr_prod_strat=e5_desc&pr_rec_id=9b38bbe94&pr_rec_pid=6721131413697&pr_ref_pid=6721131282625&pr_seq=uniform";
...
//        OkHttpClient client = new OkHttpClient();
        ...
        Request request = new Request.Builder()
                .url(baseUrl + "/apply-makeup/?choice=blush&red=204&green=128&blue=132")
                .post(requestBody)
                .build();
