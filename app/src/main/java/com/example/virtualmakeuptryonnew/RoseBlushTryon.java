...
public class RoseBlushTryon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rose_blush_tryon);
        ...
        buyProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // URL to open
                String url = "https://www.makeupcityshop.com/products/13823?pr_prod_strat=e5_desc&pr_rec_id=edc27385d&pr_rec_pid=6721131217089&pr_ref_pid=6721131479233&pr_seq=uniform";
