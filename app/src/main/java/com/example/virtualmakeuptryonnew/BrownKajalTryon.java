...
public class BrownKajalTryon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brown_kajal_tryon);
        ...
        buyProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // URL to open
                String url = "https://www.inglotpk.com/products/kohl-pencil?variant=42731963646192";
