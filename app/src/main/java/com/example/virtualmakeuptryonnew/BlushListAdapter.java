...
public class BlushListAdapter extends ArrayAdapter {

    private Activity mContext;
    List<Blush> blushList;

    public BlushListAdapter(Activity mContext, List<Blush> blushList) {
        super(mContext, R.layout.product_card, blushList);
        this.mContext = mContext;
        this.blushList = blushList;
    }
    ...
    public View getView (int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        String imageUrl = blush.getImage();
        ...
        tryOnButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = BlushTryonIntents.getTryOnIntent(productName, mContext);
                if (intent != null) {
