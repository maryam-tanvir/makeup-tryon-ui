...
public class RustyBrownBlushTryon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rusty_brown_blush_tryon);
        ...
        buyProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // URL to open
                String url = "https://www.makeupcityshop.com/products/13824";
...
//        OkHttpClient client = new OkHttpClient();
        ...
        Request request = new Request.Builder()
                .url(baseUrl + "/apply-makeup/?choice=blush&red=158&green=60&blue=14")
                .post(requestBody)
                .build();
