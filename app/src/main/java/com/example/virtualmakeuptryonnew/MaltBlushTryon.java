...
public class MaltBlushTryon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_malt_blush_tryon);
        ...
        buyProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // URL to open
                String url = "https://www.makeupcityshop.com/products/13813";
...
//        OkHttpClient client = new OkHttpClient();
        ...
        Request request = new Request.Builder()
                .url(baseUrl + "/apply-makeup/?choice=blush&red=248&green=245&blue=242")
                .post(requestBody)
                .build();
